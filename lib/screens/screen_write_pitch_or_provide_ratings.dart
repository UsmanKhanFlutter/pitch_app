...
class WritePitchOrProvideRatingsScreen extends StatefulWidget {
  @override
  _WritePitchOrProvideRatingsScreenState createState() => _WritePitchOrProvideRatingsScreenState();
}

class _WritePitchOrProvideRatingsScreenState extends State<WritePitchOrProvideRatingsScreen> {
  @override
        ...
        Column(
          ...
          children:[
            ...
            Row(
              ...
              SizedBox(
                width: ConfigSize.blockSizeHorizontal*3
              ),
              StretchedColorButton(
