        ...
        body: Stack(
          children: <Widget>[ 
            ...
            Positioned(
              ...
              child: Container(
                child: Image.asset("assets/images/top_ellipse.png",
              ...
              Positioned(
                ...
                child: Container(
                  child: Image.asset("assets/images/bottom_ellipse.png",
                  fit: BoxFit.fill,
                  ),
                ),
              ),
              ...
              child: Column(
                ...
                children: [
                  MaterialButton(
                    ...
                    elevation: 0,
                    child: "Recieve the Gift".text.white.maxFontSize(12).make(),
                    color: red,
                  ...
                  MaterialButton(
                    ...
                    elevation: 0,
                    color: Colors.white,
                    child: "Reject".text.color(red).maxFontSize(12) .make(),
                    shape: RoundedRectangleBorder(
