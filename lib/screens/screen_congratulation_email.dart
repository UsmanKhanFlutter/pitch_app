...
class CongratulationEmailScreen extends StatefulWidget {
  @override
  _CongratulationEmailScreenState createState() => _CongratulationEmailScreenState();
}
            ...
            children: [
              ...
              Container(
                ...
                child:SingleChildScrollView(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children:[
                    Text('  Congratulations! Your profile is now live on PITCH the dating site where friends pitch friends.'),
                    Text("Download PITCH to browse singles, see your matches or ask other friends to pitch you."),
                    SizedBox(
