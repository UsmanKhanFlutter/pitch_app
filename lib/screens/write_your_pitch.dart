...
class WriteYourPitchScreen extends StatefulWidget {
  @override
  _WriteYourPitchScreenState createState() => _WriteYourPitchScreenState();
}

class _WriteYourPitchScreenState extends State<WriteYourPitchScreen> {
