        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              // SizedBox(height: ConfigSize.blockSizeVertical*2),
              settingContainer(label:'Phone number', details:'0322444563'),
              // SizedBox(height: ConfigSize.blockSizeVertical*1),
              settingContainer(label:'Connected Accounts', details:''),
              // SizedBox(height: ConfigSize.blockSizeVertical*1),
              settingContainer(label:'Email', details:'tosca@gmail.com'),
              ...
              DistanceContainer(labelText: 'Maximum Distance',isAge: false,),
              showMeContainer(interestedIn:'Women'),
              DistanceContainer(labelText: 'Age Range',isAge: true,),
              textAreaContainer(),
              ShowMeOnPitchContainer(label: "Show Me on Pitch"),
              SizedBox(height: ConfigSize.blockSizeVertical*5),
              textAreaContainer(),
              SizedBox(height: ConfigSize.blockSizeVertical*3),
              settingContainer(label:'Manage Read Receipts', details:'Settings'),
              textAreaContainer(),
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            contentPadding: EdgeInsets.symmetric(
              vertical: ConfigSize.blockSizeVertical*3, 
              horizontal: 7.0),
            hintText: '',
            hintStyle: TextStyle(
              fontSize: 12,),
