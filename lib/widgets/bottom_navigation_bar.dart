                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: pageIndex == 0 ? Colors.red.shade400 : Colors.black,
                          size: 25,
                        ),
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: pageIndex == 1 ? Colors.red.shade400 : Colors.black,
                          size: 25,
                        ),
                      ),
                    ),
                  ...
                  Expanded(
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          Icons.favorite,
                          color: pageIndex == 2 ? Colors.red.shade400 : Colors.black,
                          size: 25,
                        ),
                      ),
                    ),
                    ...
                    child: Container(
                      ...
                      child: IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: pageIndex == 3 ? Colors.red.shade400 : Colors.black,
                          size: 25,
                        ),
                      ),
                    ),
...
class GettingStartedBottomNavigation extends StatefulWidget {
  @override
  _GettingStartedBottomNavigationState createState() => _GettingStartedBottomNavigationState();
}
class _GettingStartedBottomNavigationState extends State<GettingStartedBottomNavigation> {
  int pageIndex;
